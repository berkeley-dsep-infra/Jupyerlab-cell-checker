...
/* harmony import */ var _components_Spinner__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/Spinner */ "./lib/components/Spinner.js");
...
class AltCellList extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_3__.Widget {
    ...
    async generateAltText(imageData, cellId) {
        ...
        if (target) {
            ...
            const spinner = (0,_components_Spinner__WEBPACK_IMPORTED_MODULE_7__.createSpinner)(target);
            try {
                ...
                (0,_components_Spinner__WEBPACK_IMPORTED_MODULE_7__.stopSpinner)(spinner);
